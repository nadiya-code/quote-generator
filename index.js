...
const allquotes = [
  ...
  {
    type: "Philosophy",
    text: "The fear of death is the most unjustified of all fears.",
  ...
  {
    type: "Philosophy",
    text: "Freedom is the freedom to say that two plus two makes four.",
  ...
  {
    type: "Philosophy",
    text: "The only way to deal with this life meaningfully is to find a way to laugh at it.",
    author: "Albert Camus",
  },
  {
    type: "Philosophy",
  ...
  {
    type: "Literature",
    text: "Tomorrow I’ll think of some way to get him back. After all, tomorrow is another day.",
    author: "Margaret Mitchell",
  },
  {
    type: "Literature",
    text: "The past is not dead. It’s not even past.",
  ...
  {
    type: "Literature",
    text: "I can’t go back to yesterday—I was a different person then.",
    author: "Lewis Carroll",
  },
  {
    type: "Science",
  ...
  {
    type: "Science",
    text: "The heart of science is measurement.",
  ...
  {
    type: "Science",
    text: "Hubris and science are incompatible.",
    author: "Douglas Preston",
  },
  {
    type: "Science",
    text: "Science is not finished until it is communicated.",
    author: "Mark Walport",
  },
  {
    type: "Science",
    text: "Science does not permit exceptions.",
  ...
  {
    type: "Science",
    text: "Science is fun. Science is curiosity. We all have natural curiosity.",
    author: "Sally Ride",
  },
  {
    type: "Science",
  ...
  {
    type: "Science",
    text: "Science, like art, religion, commerce, warfare, and even sleep, is based on presuppositions.",
    author: "Gregory Bateson",
  },
  {
    type: "Science",
    text: "No science is immune to the infection of politics and the corruption of power.",
    author: "Jacob Bronowski",
  },
  {
    type: "Science",
    text: "Science without conscience is the death of the soul.",
    author: "Francois Rabelais",
  },
  {
    type: "Science",
    text: "In all science, error precedes the truth.",
    author: "Horace Walpole",
  },
  {
    type: "Science",
    text: "In science, the credit goes to the man who convinces the world.",
    author: "Francis Darwin",
  },
  {
    type: "Science",
    text: "Science is but an image of the truth.",
    author: "Francis Bacon",
  },
  {
    type: "Science",
    text: "Science is about developing an understanding of the world and testing predictions.",
  ...
  {
    type: "Science",
    text: "Science is wonderfully equipped to answer the question ‘How?’ but struggles with ‘Why?’",
    author: "Erwin Chargaff",
  },
  {
    type: "Science",
    text: "Science has not yet taught us if madness is or is not the sublimity of intelligence.",
  ...
  {
    type: "Science",
    text: "Science and technology are the keys to both our longevity and our demise.",
    author: "Rhys Darby",
  },
  {
    type: "Science",
    text: "Science gives us knowledge, but only philosophy can give us wisdom.",
    author: "Will Durant",
  },
  {
    type: "Science",
    text: "Science requires reasoning, while other subjects may require only scholarship.",
  ...
  {
    type: "Science",
    text: "Science is made up of mistakes that lead gradually to the truth.",
    author: "Jules Verne",
  },
  {
    type: "Science",
    text: "Scientific research is one of the most exciting and rewarding occupations.",
    author: "Frederick Sanger",
  },
  {
    type: "Science",
    text: "Science grows like a weed every year.",
    author: "Kary Mullis",
  },
  {
    type: "Science",
    text: "Science is simply common sense at its best.",
    author: "Thomas Huxley",
  },
  {
    type: "Science",
    text: "Art is I; science is we.",
    author: "Claude Bernard",
  },
  {
    type: "Science",
    text: "Science has made us gods even before we are worthy of being men.",
    author: "Jean Rostand",
  },
  {
    type: "Science",
    text: "I believe there are no questions that science can’t answer about a physical universe.",
    author: "Stephen Hawking",
  },
  {
    type: "Science",
    text: "Science is like a love affair with nature.",
    author: "Vilayanur S. Ramachandran",
  },
  {
    type: "Life",
    text: "A happy life consists in the tranquility of mind.",
    author: "Marcus Tullius Cicero",
  },
  {
    type: "Life",
    text: "Almost nothing material is needed for a happy life.",
    author: "Marcus Aurelius",
  },
  {
    type: "Life",
    text: "The realization that life is absurd cannot be an end, but only a beginning.",
    author: "Albert Camus",
  },
  {
    type: "Life",
  ...
  {
    type: "Life",
    text: "Three things in life – your health, your mission, and the people you love.",
  ...
  {
    type: "Life",
    text: "Difficult and meaningful will always bring more satisfaction than easy and meaningless.",
  ...
  {
    type: "Life",
    text: "Do not squander time, for that is the stuff life is made of.",
    author: "Benjamin Franklin",
  },
  {
    type: "Life",
    text: "It’s a terrible thing in life to wait until you’re ready.",
    author: "Hugh Laurie",
  },
  {
    type: "Life",
  ...
  {
    type: "Life",
    text: "Life is a book you write, not a movie you watch.",
    author: "Maxime Lagacé",
  },
  { type: "Life", text: "My life is my message.", author: "Mahatma Gandhi" },
  {
    type: "Life",
    text: "Life is a mountain. Your goal is to find your path.",
    author: "Maxime Lagacé",
  },
  {
    type: "Life",
  ...
  {
    type: "Life",
    text: "Live the life that only you can live.",
    author: "Naval Ravikant",
  },
  {
    type: "Life",
    text: "Don’t search for the meaning of life. Simply be present for the people you love.",
    author: "Maxime Lagacé",
  },
  {
    type: "Life",
    text: "You cannot be afraid to disappoint people. You have to live the life you want.",
    author: "David Goggins",
  },
  {
    type: "Life",
    text: "Life is nothing but a mirror of your consistent thoughts.",
    author: "Tony Robbins",
  },
  {
    type: "Life",
  ...
  {
    type: "Life",
    text: "You can’t think your way into a better life, you have to live it.",
    author: "Mark Manson",
  },
  {
    type: "Life",
  ...
  {
    type: "Life",
    text: "Each person’s task in life is to become a better person.",
    author: "Leo Tolstoy",
  },
  {
    type: "Life",
  ...
  {
    type: "Life",
    text: "If you want to live a happy life, tie it to a goal.",
    author: "Albert Einstein",
  },
  {
    type: "Life",
    text: "The cost for the good life is giving up comfort.",
    author: "Maxime Lagacé",
  },
  {
    type: "Life",
  ...
  {
    type: "Courage",
    text: "Courage is a perfect sensibility of the measure of danger, and a mental willingness to endure it.",
    author: "William Tecumseh Sherman",
  },
  {
    type: "Courage",
    text: "Courage is the resolution to face the unforeseen.",
    author: "Agatha Christie",
  },
  {
    type: "Courage",
    text: "Courage is the complexion of virtue.",
    author: "Diogenes Laertius",
  },
  { type: "Courage", text: "Courage is a kind of salvation.", author: "Plato" },
  {
    type: "Courage",
    text: "Courage is the power of the mind to overcome fear.",
  ...
  {
    type: "Courage",
    text: "Courage is an inner resolution to go forward despite obstacles.",
    author: "Martin Luther King Jr.",
  },
  {
    type: "Courage",
    text: "Courage is one step ahead of fear.",
    author: "Coleman Young",
  },
  {
    type: "Courage",
    text: "Courage in danger is half the battle.",
    author: "Plautus",
  },
  {
    type: "Courage",
    text: "Courage is the enforcing virtue that makes all others possible.",
    author: "John McCain",
  },
  {
    type: "Courage",
    text: "Courage is the ability to do the right thing no matter how painful it is.",
    author: "Tony Dungy",
  },
  {
    type: "Courage",
  ...
  {
    type: "Courage",
    text: "Courage is like love; it must have hope to nourish it.",
    author: "Napoleon Bonaparte",
  },
  { type: "Courage", text: "Courage conquers all things.", author: "Ovid" },
  {
    type: "Courage",
    text: "Being deeply loved gives you strength; loving deeply gives you courage.",
    author: "Lao Tzu",
  },
  {
    type: "Courage",
  ...
  {
    type: "Courage",
    text: "Courage is resistance to fear, not absence of fear.",
    author: "Mark Twain",
  },
  {
    type: "Courage",
  ...
  {
    type: "Courage",
    text: "Everyone has talent. What's rare is the courage to follow it.",
    author: "Erica Jong",
  },
  {
    type: "Courage",
  ...
  {
    type: "Courage",
    text: "The greatest test of courage is to bear defeat without losing heart.",
  ...
  {
    type: "Courage",
    text: "The lion doesn't turn around when the small dog barks.",
    author: "Unknown",
  },
  {
    type: "Courage",
  ...
  {
    type: "Courage",
    text: "A true leader has the courage to make tough decisions.",
    author: "Unknown",
  },
  {
    type: "Courage",
    text: "Courage is not the absence of fear, but the conquest of it.",
    author: "William Danforth",
  },
  {
    type: "Courage",
    text: "Courage is like a muscle; we strengthen it with use.",
    author: "Ruth Gordon",
  },
  {
    type: "Courage",
  ...
  {
    type: "Creativity",
    text: "Write while the heat is in you.",
    author: "Henry David Thoreau",
  },
  {
    type: "Creativity",
  ...
  {
    type: "Creativity",
    text: "To practice any art is a way to make your soul grow.",
    author: "Kurt Vonnegut",
  },
  {
    type: "Creativity",
  ...
  {
    type: "Creativity",
    text: "You can’t wait for inspiration. You have to go after it.",
    author: "Jack London",
  },
  {
    type: "Creativity",
    text: "Creativity is inventing, experimenting, growing, taking risks, and having fun.",
  ...
  {
    type: "Creativity",
    text: "Every child is an artist. The problem is how to remain one.",
    author: "Pablo Picasso",
  },
  {
    type: "Creativity",
    text: "Creativity is allowing yourself to make mistakes.",
    author: "Scott Adams",
  },
  {
    type: "Creativity",
  ...
  {
    type: "Creativity",
    text: "To draw, you must close your eyes and sing.",
    author: "Pablo Picasso",
  },
  {
    type: "Creativity",
  ...
  {
    type: "Creativity",
    text: "Creativity is seeing something that doesn’t exist already.",
    author: "Michele Shea",
  },
  {
    type: "Creativity",
  ...
  {
    type: "Creativity",
    text: "The true sign of intelligence is imagination.",
    author: "Albert Einstein",
  },
  {
    type: "Creativity",
    text: "I have not failed. I’ve just found ways that won’t work.",
    author: "Thomas Edison",
  },
  {
    type: "Creativity",
    text: "Creativity is thinking up new things. Innovation is doing new things.",
  ...
  {
    type: "Creativity",
    text: "To invent, you need imagination and a pile of junk.",
    author: "Thomas Edison",
  },
  {
    type: "Creativity",
    text: "Science is the process that takes us from confusion to understanding.",
    author: "Brian Greene",
  },
  {
    type: "Creativity",
...
function renderSavedQuotes() {
  const saved_grid = document.querySelector(".saved-grid");
  if (!saved_grid) {
    console.error("saved-grid not found");
    return;
  }
  ...
  savedQuotes.forEach((q) => {
    ...
    card.className =
      "quote-card flex flex-col text-start border p-[20px] rounded-lg gap-3 m-3";
    card.innerHTML = `
    <div class="flex justify-between">
       <p class=" type text-lg gap-3 w-80 uppercase">${q.type}</p>
       <i class="fa-regular fa-heart fa-solid hearts text-pink"></i>
    </div>
    ...
    <div class="flex gap-3 justify-start">
       <button class="view border m-2 p-2 rounded-lg">View</button>
       <button class="copy border m-2 p-2 rounded-lg">Copy</button>
       <button class=" Unsave border m-2 p-2 rounded-lg">Unsave</button>
    </div>
    `;
...
button.forEach((btn) => {
  btn.addEventListener("mouseenter", () => {
    if (
      !btn.classList.contains("new-quote") &&
...
function renderquotes() {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    let card = document.createElement("div");
    card.className =
      "quote-card  flex flex-col text-start border p-[20px] rounded-lg gap-3";
    card.innerHTML = `
